...
async function getProfileName() {
  const { data, error } = await supabase.from('profile').select('pname').eq('email', 'uae@email.com')
...
//note to myself added email column to profile send saved email into profile
